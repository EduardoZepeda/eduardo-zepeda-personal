...
export const portfolioData: PortfolioProject[] = [
    {
        ...
        info: 'SAAS, price tracking web app and browser extension. Mercado Libre, Amazon and others, focused on Smartphones, more than +80k products tracked, +1M prices, drop price alert system. Newsletter with affiliate link system for recent offers.',

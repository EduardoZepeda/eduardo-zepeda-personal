  ...
  return (
    <section id='about'>
      ...
      <div className={styles.aboutMe}>
        ...
        <p>Author at <a href='https://coffeebytes.dev' rel='noreferrer noopener' target='_blank' aria-label='Coffee bytes website'>Coffee bytes, </a>+100 entries about web developing, +500 devs subscribed.</p>
      </div>
    </section>
  )
}
